...
.. seo::
    :description: Instructions for setting up USB HID devices (keyboards, mice, gamepads) in ESPHome.
    :image: usb.svg
...
See :doc:`/components/usb_i2c` for I2C bridge configuration.
...
- All other options from :ref:`Text Sensor <config-text_sensor>` or :ref:`Binary Sensor <config-binary_sensor>`.
...
- All other options from :ref:`Binary Sensor <config-binary_sensor>` or :ref:`Sensor <config-sensor>`.
...
- :doc:`/components/usb_i2c`
- :doc:`/components/binary_sensor/index`
- :doc:`/components/sensor/index`
- :doc:`/components/text_sensor/index`
- :apiref:`usb_hidx/usb_hidx.h`
- :ghedit:`Edit`
