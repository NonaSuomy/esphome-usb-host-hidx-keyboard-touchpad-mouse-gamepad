...
.. seo::
    :description: Instructions for using USB-to-I2C bridges with ESPHome.
    :image: usb.svg
...
- **id** (*Optional*, :ref:`config-id`): Manually specify the ID for this I2C bus.
...
- Verify ESP32-S3 variant is specified
- Update ESPHome to latest version

See Also
--------

- :doc:`/components/usb_hidx`
- :doc:`/components/i2c`
- :doc:`/components/sensor/index`
- :apiref:`usb_i2c/usb_i2c.h`
- :ghedit:`Edit`
